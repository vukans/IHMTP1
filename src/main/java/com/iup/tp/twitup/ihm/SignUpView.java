...
public class SignUpView extends ViewBase implements ISignedUpObserver {
	...
	public SignUpView() {
		...
		ImageIcon tagueImg = new ImageIcon(ClassLoader.getSystemResource("images/tague.png"));
		...
		ImageIcon usernemImg = new ImageIcon(ClassLoader.getSystemResource("images/usernem.png"));
		...
		ImageIcon depecheModePasseImg = new ImageIcon(ClassLoader.getSystemResource("images/depechemodepasse.png"));
